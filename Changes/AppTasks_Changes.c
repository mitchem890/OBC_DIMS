...
//TODO Remove these before Full realease
bool do_XCAM = true; // utilize the XCAM
bool do_XCAM_Toggle_Power=true; //Toggle Power before Using
bool do_XCAM_Exposure=true; //Take an Exposure
...
void StartDefaultTask(void const * argument)
{
    ...
    if (do_XCAM) {
        if (do_XCAM_Toggle_Power){XCAM_Toggle();}
...
/*
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * Turn Off Magnetometers
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 */
void Magnetorquer_PowerOff(){
 ...
 * Eidited mjeffers@ucar.edu 2022 01 18
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 */
...
void XCAM_PowerOff(){
    ...
    XCAM_WaitSeconds(30,1); // wait for everything to settle
    EPS_check(0,1);
}
...
void XCAM_Exposure(void) {
    ...
    //Make Sure there is no Data waiting
